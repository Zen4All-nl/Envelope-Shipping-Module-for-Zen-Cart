...
?>
          ...
          <tr>
            <td class="main"><?php echo TEXT_PRODUCTS_QTY_ENVELOPE; ?></td>
            <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_input_field('products_qty_envelope', $pInfo->products_qty_envelope, zen_set_field_length(TABLE_PRODUCTS, 'products_qty_envelope')); ?></td>
          </tr>
          <tr>
            <td colspan="2"><?php echo zen_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
          </tr>
