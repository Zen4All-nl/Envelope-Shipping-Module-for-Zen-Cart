...
define('TEXT_PRODUCT_NOT_VIRTUAL', 'Nee');
define('TEXT_PRODUCT_IS_ALWAYS_FREE_SHIPPING', 'Ja');
define('TEXT_PRODUCT_NOT_ALWAYS_FREE_SHIPPING', 'Nee');
...
define('TEXT_PRODUCTS_QTY_BOX_STATUS_ON', 'Ja, Toon de Voorraad');
define('TEXT_PRODUCTS_QTY_BOX_STATUS_OFF', 'Nee, Toon NIET de Voorraad');
...
// Products and Attributes Copy Options
...
// Products and Discount Copy Options
  ...
  define('ICON_ATTRIBUTES','Eigenschap te verwachten');

  define('TEXT_CATEGORIES_IMAGE_DIR','Overbrengen naar directory:');

  define('TEXT_PRODUCTS_QTY_BOX_STATUS_PREVIEW','<strong>Waarschuwing</strong>: Laat geen voorraad zien, standaard ingesteld op 1');
  define('TEXT_PRODUCTS_QTY_BOX_STATUS_EDIT','<strong>Waarschuwing</strong>: Laat geen voorraad zien, standaard ingesteld op 1');
  ...
  define('TEXT_PRODUCTS_PRICED_BY_ATTRIBUTES_PREVIEW','<strong>*</strong> Getoonde prijs bestaat uit prijs inclusief standaardopties en eventueel gekozen opties');
  define('TEXT_PRODUCTS_PRICED_BY_ATTRIBUTES_EDIT','<strong>*</strong> Getoonde prijs bestaat uit prijs inclusief standaardopties en eventueel gekozen opties');
  ...
  define('TEXT_PRODUCTS_QUANTITY_MAX_RETAIL_EDIT','0 = onbeperkt, <strong>v.a. 1</strong> = maximum aantal bestelhoeveelheid');
